...
> = {
  CapabilityMap: {
    // Supports capability-to-process decomposition and optional process-to-application realization.
  ...
  ImpactView: {
    allowedElementTypes: ['Programme', 'Capability', 'Application', 'Technology'],
