...
const AnalysisTree: React.FC = () => {
  ...
  const includeRoadmap = isRoadmapAllowedForLifecycleCoverage(metadata?.lifecycleCoverage);
  const includeGap = isGapAnalysisAllowedForLifecycleCoverage(metadata?.lifecycleCoverage);
